{
    flake.modules.homeManager.desktop = {
        ...
        contactsDir = "${config.xdg.dataHome}/contacts/personal";
    ...
    in {
        ...
        xdg.configFile."vdirsyncer/config".text =
            ...
            ''
                ...
                password.fetch = ["shell", "cat $XDG_RUNTIME_DIR/agenix/token-fastmail-vdirsyncer"]
            '';
        ...
        xdg.configFile."aerc/accounts.conf".text =
            ...
            ''
                ...
                outgoing-cred-cmd    = cat ${config.age.secrets.token-fastmail-aerc.path}
        ...
        xdg.configFile."isyncrc".text = ''
            ...
            PassCmd "cat ${config.age.secrets.token-fastmail-mbsync.path}"
            TLSType IMAPS
        ...
        systemd.user.services.mail-sync = {
            ...
            Service = {
                Type = "oneshot";
                ExecStart = pkgs.writeShellScript "mail-sync-notify" ''
                    ...
                    if [ $NEW -gt 0 ]; then
                        ${pkgs.libnotify}/bin/notify-send --app-name="mail-sync" --icon=mail-unread "New email(s)" "You have received $NEW new email(s)"
                    fi
                '';
