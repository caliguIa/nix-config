{
    ...
    systemd.tmpfiles.rules = [
        ...
        "d /data/downloads/complete/books 0755 media media -"
        "d /data/downloads/complete/comics 0755 media media -"
        ...
        "d /data/media/music 0755 media media -"
        "d /data/media/books 0755 media media -"
        "d /data/media/comics 0755 media media -"
